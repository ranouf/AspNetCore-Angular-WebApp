...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v11.8.1.0 (NJsonSchema v9.6.5.0 (Newtonsoft.Json v9.0.0.0)) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class AuthenticationService extends ServiceBase {
    ...
    login(dto: CredentialsDto | null): Observable<string | null> {
    ...
    protected processLogin(response: Response): Observable<string | null> {
        const status = response.status; 
