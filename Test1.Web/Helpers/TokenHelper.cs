...
namespace Test1.Web.Helpers
{
  public static class TokenHelper
  {
    public static string GenerateToken(AuthenticationSettings authSettings, User user)
    {
      var tokenDescriptor = new SecurityTokenDescriptor
      {
        ...
        Expires = DateTime.UtcNow.AddDays(authSettings.ExpirationDurationInDays),
